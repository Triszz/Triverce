  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      ...
      <aside className="w-64 shrink-0 bg-white border-r border-slate-200 flex flex-col">
        ...
        <Link
          to="/"
          className="h-16 flex items-center gap-2 px-6 border-b border-slate-200"
        >
          <span className="w-9 h-9 rounded-lg bg-[#002b5b] text-white flex items-center justify-center">
            <Store size={18} aria-hidden />
          </span>
          <div className="leading-tight">
            <p className="text-sm font-semibold text-slate-900">Seller Hub</p>
            <p className="text-xs text-slate-500">Triverce Admin</p>
          </div>
        </Link>
        ...
        <div className="p-3 border-t border-slate-200">
          <button
            ...
            className="flex items-center gap-3 w-full rounded-lg px-3 py-2.5 text-sm font-medium text-slate-600 hover:bg-red-50 hover:text-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
